...
public class VraClientTest {
    ...
    public void testGetParmsAndMeta() throws Exception {
        ...
        assertEquals(“localhost", meta.get(VrServiceInstance.HOST));
        assertEquals("https://localhost/catalog-service/api/consumer/resources/9450b691-4b5a-43b4-8cd1-a54912c4ba85/actions/25e17ec5-e2fd-4bba-bb3b-25b69dd18bd7/requests/template",
                meta.get(VrServiceInstance.DELETE_TEMPLATE_LINK));
        assertEquals("https://localhost/catalog-service/api/consumer/resources/9450b691-4b5a-43b4-8cd1-a54912c4ba85/actions/25e17ec5-e2fd-4bba-bb3b-25b69dd18bd7/requests",
